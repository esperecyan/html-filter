...
class FilterTest extends \PHPUnit_Framework_TestCase implements \Psr\Log\LoggerInterface
{
     ...
     */
    public function testFilter($whitelist, string $input, string $output, array $logs)
    {
        $filter = new Filter($whitelist);
...
EOD
     ...
     */
    public function testInvalidArgumentException(array $whitelist)
    {
